*prepares QLFS 2010 wave 4 to append to other QLFSs
*A Kerr, Nov 2012
...
local datafolder="C:\Users\admin\Desktop\Andy\DataFirst\main project\Quarterly LFS\LFS 2010_4\Data"

	use "`datafolder'\QLFS 2010_4 Worker_v1.0.dta"
	...
	*now here I must put in the income data from the LMD...
	sort uqno personno
	merge 1:1 uqno personno using "`mergefolder'\lmdincomes2010q4.dta"
		
	quietly do "`mergefolder'\QLFSrename2010_4.do"
...
*sort personid
numlabel, add
save "`mergefolder'\qlfs2010_4.dta", replace
