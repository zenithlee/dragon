*prepares QLFS 2008 wave 3 to append to other QLFSs
*A Kerr, April 2012
...
local datafolder="C:\Users\admin\Desktop\Andy\DataFirst\main project\Quarterly LFS\LFS 2008_3 v2\Data\STATA"

	use "`datafolder'\LFS 2008_3.dta"
	renvars, lower
	...
	quietly do "`mergefolder'\QLFSrename2008_3.do"
...
*sort personid
numlabel, add
save "`mergefolder'\qlfs2008_3.dta", replace
