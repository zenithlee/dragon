*prepares QLFS 2009 wave 2 to append to other QLFSs
*A Kerr, April 2012
...
local datafolder="C:\Users\admin\Desktop\Andy\DataFirst\main project\Quarterly LFS\LFS 2009_2\Data\STATA"

	use "`datafolder'\LFS 2009_2 Downloaded.dta"
	...
	*no psu creation needed, in the data already...
	...
	quietly do "`mergefolder'\QLFSrename2009_2.do"
...
*sort personid
numlabel, add
save "`mergefolder'\qlfs2009_2.dta", replace
