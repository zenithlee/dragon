*prepares QLFS 2011 wave 2 to append to other QLFSs
*A Kerr, Nov 2012
...
local datafolder="C:\Users\admin\Desktop\Andy\DataFirst\main project\Quarterly LFS\LFS 2011_2\Data"

	use "`datafolder'\QLFS 2011_2 Worker_v1.0.dta"
	...
	*now here I must put in the income data from the LMD...
	sort uqno personno
	merge 1:1 uqno personno using "`mergefolder'\lmdincomes2011q2.dta"
	*one not matched.
	
	 tab _merge
		
	quietly do "`mergefolder'\QLFSrename2011_2.do"
...
*sort personid
numlabel, add
save "`mergefolder'\qlfs2011_2.dta", replace
