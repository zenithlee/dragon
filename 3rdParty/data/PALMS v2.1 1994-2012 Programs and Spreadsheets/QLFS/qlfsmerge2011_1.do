*prepares QLFS 2011 wave 1 to append to other QLFSs
*A Kerr, Nov 2012
...
local datafolder="C:\Users\admin\Desktop\Andy\DataFirst\main project\Quarterly LFS\LFS 2011_1\Data"

	use "`datafolder'\QLFS 2011_1 Worker_v1.0.dta"
	...
	*now here I must put in the income data from the LMD...
	sort uqno personno
	merge 1:1 uqno personno using "`mergefolder'\lmdincomes2011q1.dta"
	
	 tab _merge
	 *not a perfect match here!
	
	
	quietly do "`mergefolder'\QLFSrename2011_1.do"
...
*sort personid
numlabel, add
save "`mergefolder'\qlfs2011_1.dta", replace
