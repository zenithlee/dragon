*prepares QLFS 2008 wave 4 to append to other QLFSs
*A Kerr, April 2012
...
local datafolder="C:\Users\admin\Desktop\Andy\DataFirst\main project\Quarterly LFS\LFS 2008_4\Data\STATA"

	use "`datafolder'\LFS 2008_4.dta"
	renvars, lower
	...
	quietly do "`mergefolder'\QLFSrename2008_4.do"
...
*sort personid
numlabel, add
save "`mergefolder'\qlfs2008_4.dta", replace
