*prepares QLFS 2011 wave 3 to append to other QLFSs
*A Kerr, Jan 2013
...
local datafolder="C:\Users\admin\Desktop\Andy\DataFirst\main project\Quarterly LFS\LFS 2011_3\Data"

	use "`datafolder'\QLFS 2011_3 Worker_v1.0.dta"
	...
	*now here I must put in the income data from the LMD...
	sort uqno personno
	merge 1:1 uqno personno using "`mergefolder'\lmdincomes2011q3.dta"
	 tab _merge
	 *3 not matched
		
	quietly do "`mergefolder'\QLFSrename2011_3.do"
...
*sort personid
numlabel, add
save "`mergefolder'\qlfs2011_3.dta", replace
